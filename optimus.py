...
TELEGRAM_BOT_TOKEN = '8193429379:AAHqkR8oxSizRV4l8RVr-2edk9TlNJXj-iA'
ADMIN_USER_ID = 6926366670
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        "*🔥 Welcome to the OptimusDDoS By @Optimus_AK 🔥*\n\n"
        "*Use /attack <ip> <port> <duration>*\n"
        "*Let Start Fucking the Game*"
    )
...
async def run_attack(chat_id, ip, port, duration, context):
    ...
    try:
        ...
        attack_in_progress = False
        await context.bot.send_message(chat_id=chat_id, text="*✅ Attack Completed! ✅*\n*Thank you for using our OptimusDDoS service!*", parse_mode='Markdown')
